...
const Home = () => {
  ...
  const SearchtheRoomPage = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://room-rent-server.onrender.com/api", {
        method: "GET",
        headers: {
    ...
    <>
      ...
      <div className="user_search_list">
        ...
        <div className="search_details">
          {!Loading &&
            userData.map((document) => (
              <div key={document._id} className="search_result_box">
                <p className="status_details">open</p>
                <p>
                  <span className="room_details">Name</span> - {document.Name}
                </p>
                <p>
                  <span className="room_details">City </span> - {document.City}
                </p>
                <p>
                ...
                <p>
                  <span className="room_details">Type</span> - {document.Type}
                </p>
                <p>
                  <span className="room_details">Place</span> - {document.Place}
                </p>
                <p>
                  <span className="room_details">Price</span> -{" "}
                  {document.HouseNumber ? document.HouseNumber : "not given"}
                </p>
                <p>
